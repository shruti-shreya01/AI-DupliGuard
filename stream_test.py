...
if text_area is not None:
    if st.button("Analyze"):
        ...
        with col2:
            ...
            burstiness_score = calculate_burstiness(text_area)
            bigram_freq, trigram_freq = calculate_ngram_features(text_area)

            st.write("Perplexity:", perplexity)
            st.write("Burstiness Score:", burstiness_score)
            st.write("Top Bigrams:", bigram_freq.most_common(5))
            st.write("Top Trigrams:", trigram_freq.most_common(5))
